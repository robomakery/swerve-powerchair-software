...
#Help variable
	...
	pub_vel_vr.publish(100*vfr)
	pub_vel_vl.publish(100*vfl)
	pub_vel_hl.publish(100*vrl)
	pub_vel_hr.publish(100*vrr)
...
# publishing to "turtle1/cmd_vel" to control turtle1
	...
	pub_vel_vl = rospy.Publisher('/grisho/velocity/fork_to_wheel_vr/command', Float64,queue_size=5)
	pub_pos_vl = rospy.Publisher('/grisho/position/base_to_rot_fork_vr/command', Float64,queue_size=5)
	pub_vel_vr = rospy.Publisher('/grisho/velocity/fork_to_wheel_vl/command', Float64,queue_size=5)
	pub_pos_vr = rospy.Publisher('/grisho/position/base_to_rot_fork_vl/command', Float64,queue_size=5)
	pub_vel_hl = rospy.Publisher('/grisho/velocity/fork_to_wheel_hr/command', Float64,queue_size=5)
	pub_pos_hl = rospy.Publisher('/grisho/position/base_to_rot_fork_hr/command', Float64,queue_size=5)
	pub_vel_hr = rospy.Publisher('/grisho/velocity/fork_to_wheel_hl/command', Float64,queue_size=5)
	pub_pos_hr = rospy.Publisher('/grisho/position/base_to_rot_fork_hl/command', Float64,queue_size=5)
