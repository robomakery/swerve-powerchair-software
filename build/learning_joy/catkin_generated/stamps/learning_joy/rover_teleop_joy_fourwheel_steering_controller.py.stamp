...
#	rospy.init_node('teleop_rover_swerve_steering_controller',anonymous=True)
	...
	pub_transl_x = rospy.Publisher('/four_wheel_steering_controller/cmd_vel',Twist,queue_size=3)
	rospy.init_node('teleop_rover_fourwheel_steering_controller',anonymous=True)	
	
	
	pub_steer_front = rospy.Publisher('/four_wheel_steering_controller/cmd_four_wheel_steering', FourWheelSteering, queue_size=3)
